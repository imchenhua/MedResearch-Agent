...
export type AppShellMenubarProps = {
	...
	t: TFunction;
	shell: Window['medresearchShell'] | undefined;
...
const HELP_DOC_URL = 'https://github.com/imchenhua/MedResearch-Agent#readme';
const HELP_ISSUES_URL = 'https://github.com/imchenhua/MedResearch-Agent/issues/new';
const HELP_RELEASES_URL = 'https://github.com/imchenhua/MedResearch-Agent/releases';
