...
export interface MedResearchShellAPI {
...
declare global {
interface MedResearchShellWebviewElement extends HTMLElement {
		canGoBack(): boolean;
	...
	namespace JSX {
		interface IntrinsicElements {
			webview: React.DetailedHTMLProps<React.WebViewHTMLAttributes<MedResearchShellWebviewElement>, MedResearchShellWebviewElement>;
		}
	}

	interface Window {
		medresearchShell?: MedResearchShellAPI;
