...
type Shell = NonNullable<Window['medresearchShell']>;

const AGENT_WORKSPACE_ALIASES_KEY = 'medresearch:agent-workspace-aliases-v1';
const AGENT_WORKSPACE_HIDDEN_KEY = 'medresearch:agent-workspace-hidden-v2';
const AGENT_WORKSPACE_COLLAPSED_KEY = 'medresearch:agent-workspace-collapsed-v2';
