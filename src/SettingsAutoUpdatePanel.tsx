...
export function SettingsAutoUpdatePanel({ shell }: SettingsAutoUpdatePanelProps) {
	...
	useEffect(() => {
		...
		const medresearchShell = shell as any;
		const unsubscribe = medresearchShell.subscribeAutoUpdateStatus((status: AutoUpdateStatus) => {
				...
				<div className="ref-settings-agent-card-row">
					<div>
						<div className="ref-settings-agent-card-title">
							MedResearch Agent v{currentVersion}
						</div>
