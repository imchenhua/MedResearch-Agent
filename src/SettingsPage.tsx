...
const SETTINGS_SIDEBAR_KEY = 'medresearch:settings-sidebar-w-v1';
...
type Props = {
	...
	shell: NonNullable<Window['medresearchShell']> | null;
												...
												options={[
													{
														...
														label: t('settings.general.identityPreset.medresearch'),
													},
													{
														value: 'claude-code',
										...
										{resolvedProviderIdentity.preset === 'custom' ? (
											...
											<p className="ref-settings-field-hint" style={{ marginTop: 4 }}>
												{resolvedProviderIdentity.preset === 'claude-code'
													...
													: t('settings.general.identityPresetDefaultHint')}
											</p>
										)}
									</div>
															...
															<label className="ref-settings-field ref-settings-field--compact">
																...
																<VoidSelect
																	...
																	options={[
																		...
																		{ value: 'medresearch-default', label: t('settings.general.identityPreset.medresearch') },
