		...
		<div className="ref-uterm-settings-workspace">
			<aside className="ref-uterm-settings-sidebar">
				<div className="ref-uterm-settings-sidebar-head">
					<div className="ref-uterm-settings-sidebar-kicker">MedResearch Agent</div>
...
function ProfilesSettingsStage({
	...
	const loadPasswordState = useCallback(async (profileId: string) => {
		const shell = window.medresearchShell;
		if (!shell || !profileId) {
	...
	const closeProfileEditor = useCallback(() => {
		...
		if (
			...
			void window.medresearchShell?.invoke('term:profilePasswordClear', editorDraft.id);
		}
		setEditorDraft(null);
		setDefaultsKind(null);
		setEditorHasSavedPassword(false);
																			...
																			{!isBuiltin ? (
																				<button
																					...
																					onClick={(event) => {
																						...
																						void window.medresearchShell?.invoke('term:profilePasswordClear', profile.id);
																						if (isActive) {
																							setEditorDraft(null);
