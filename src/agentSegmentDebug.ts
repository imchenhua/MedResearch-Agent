 ...
 * 在 DevTools 执行：localStorage.setItem('MEDRESEARCH_DEBUG_AGENT_SEGMENTS', '1') 后刷新。
 * 关闭：localStorage.removeItem('MEDRESEARCH_DEBUG_AGENT_SEGMENTS')
 */
const STORAGE_KEY = 'MEDRESEARCH_DEBUG_AGENT_SEGMENTS';
