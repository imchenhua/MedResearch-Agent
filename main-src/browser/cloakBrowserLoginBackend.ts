 ...
 *
 * CloakBrowser 的核心反检测在预编译 Chromium 二进制（C++ 补丁），MedResearch Agent 内置 Electron
 ...
 * 3. 用户在 CloakBrowser 窗口完成登录；按需求导出 cookie 到 MedResearch Agent partition 或仅用于 Agent 会话
 *
