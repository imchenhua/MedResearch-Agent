...
export type AgentRule = {
	...
	globPattern?: string;
	enabled: boolean;
	/** user = 全局设置；project = 当前仓库 `.medresearch/agent.json` */
...
export type AgentCustomization = {
	...
	/** 控制何时触发 `.medresearch/memory` 后台抽取，减少每轮都调用模型 */
