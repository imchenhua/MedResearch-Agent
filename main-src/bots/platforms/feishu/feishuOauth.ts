...
</head><body><main><h1>✓ Authorization complete</h1><p>You can close this window and return to MedResearch Agent.</p></main></body></html>`;
...
</head><body><main><h1>Authorization failed</h1><p>${reason.replace(/[<>&]/g, '')}</p><p>You can close this window and try again from MedResearch Agent.</p></main></body></html>`;
}
