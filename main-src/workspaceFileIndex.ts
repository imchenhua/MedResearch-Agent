...
const AUTO_ATTACH_WORKSPACE_FILE_WATCHER = process.env.MEDRESEARCH_ENABLE_WORKSPACE_FILE_WATCHER === '1';
...
const SKIP_RELATIVE_PREFIXES = [
	'.medresearch/index/',
	'.medresearch/memory/',
	'.medresearch/composer-drops/',
	'.medresearch/agent-memory/',
	'.medresearch/agent-memory-local/',
];
