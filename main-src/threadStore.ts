...
import { resolveMedResearchDataDir } from './dataDir.js';
...
const SYSTEM_PROMPT =
	'You are MedResearch Agent, a research assistant for clinical and medical research. The user workspace is open in the app.';
